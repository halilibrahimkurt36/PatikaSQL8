...
--UPDATE employee SET name='HALIL' WHERE id=5 RETURNING *;
--UPDATE employee SET birthday='1990-03-23' WHERE name LIKE 'T%' RETURNING *;
--UPDATE employee SET name = 'Behtefer' WHERE name LIKE '%n' RETURNING * ;
--UPDATE employee SET name='Kerem',birthday='2015-05-05',email='kerem@kurt.com' WHERE id=33 RETURNING*;
--UPDATE employee SET birthday='2015-05-05' WHERE birthday > '1990-01-01' RETURNING*;

--DELETE FROM employee WHERE id=6;
--DELETE FROM employee WHERE name='HALIL' RETURNING *;
--DELETE FROM employee WHERE name LIKE 'T%' RETURNING *;
--DELETE FROM employee WHERE birthday <'2015.05.05' RETURNING *;
--DELETE FROM employee WHERE email LIKE '%m' RETURNING *